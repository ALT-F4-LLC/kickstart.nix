...
> [!NOTE]
> Dont forget to remove the throw statements when inserting your homeDirectory and username. Otherwise you will get an error similar to the below where 'bwsdm' is the username
